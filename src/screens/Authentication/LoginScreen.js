    ...
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.inputContainer}>
          <Mail size={20} color="#87CEEB" style={styles.inputIcon} />
          <TextInput
            style={styles.input}
        ...
        <View style={styles.inputContainer}>
          <Lock size={20} color="#87CEEB" style={styles.inputIcon} />
          <TextInput
            style={styles.input}
        ...
        <TouchableOpacity style={styles.button} onPress={handleLogin}>
          ...
          >
            {loginType === "business" ? (
              <Building2 size={20} color="#1a1a2e" style={{ marginRight: 8 }} />
            ) : (
              <User size={20} color="#1a1a2e" style={{ marginRight: 8 }} />
            )}
