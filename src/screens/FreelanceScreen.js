        ...
        <View style={styles.businessSection}>
          ...
          <TouchableOpacity style={styles.card}>
            <View style={styles.placeholderImage}>
              <Ionicons name="laptop" size={30} color="#34495E" />
            </View>
          ...
          <TouchableOpacity style={styles.card}>
            <View style={styles.placeholderImage}>
              <Ionicons name="camera" size={30} color="#34495E" />
            </View>
            <View style={styles.cardContent}>
          ...
          <TouchableOpacity style={styles.card}>
            <View style={styles.placeholderImage}>
              <Ionicons name="brush" size={30} color="#34495E" />
            </View>
            <View style={styles.cardContent}>
          ...
          <TouchableOpacity style={styles.card}>
            <View style={styles.placeholderImage}>
              <Ionicons name="document-text" size={30} color="#34495E" />
            </View>
            <View style={styles.cardContent}>
          ...
          <TouchableOpacity style={styles.card}>
            <View style={styles.placeholderImage}>
              <Ionicons name="musical-notes" size={30} color="#34495E" />
            </View>
            <View style={styles.cardContent}>
